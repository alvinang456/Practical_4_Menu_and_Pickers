...
public class OrderActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    public void addListenerOnButtonClick() {
        check1 = (CheckBox) findViewById(R.id.chocolate_check_box);
        check2 = (CheckBox) findViewById(R.id.Sprinkles_check_box);
        check3 = (CheckBox) findViewById(R.id.crushed_check_box);
        check4 = (CheckBox) findViewById(R.id.Cherries_check_box);
        check5 = (CheckBox) findViewById(R.id.orio_check_box);
